...
class SiteController extends Controller
{
    public function actionRss(){
        ...
        $feed->setTitle(Yii::$app->params['post.title']);
        $feed->setLink('http://localhost/blogdemo2/backend/web/index.php');
        $feed->setFeedLink('http://localhost/blogdemo2/backend/web/index.php/rss', 'rss');
        $feed->setDescription(Yii::t('app','Recent headlines'));
        $feed->setGenerator('http://localhost/blogdemo2/backend/web/index.php/rss');
